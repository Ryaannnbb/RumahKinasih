                                ...
                                <div class="col mx-auto">
                                    <div class="auth-form-box">
                                        ...
                                        <form action="{{ route('postlogin') }}" method="POST">
                                            ...
                                            <div class="mb-3 text-start">
                                                ...
                                                <div class="form-icon-container">
                                                    <input class="form-control form-icon-input @error('email') is-invalid @enderror" id="email" type="email" name="email" placeholder="name@example.com" value="{{ old('email') }}" />
                                            ...
                                            <div class="mb-3 text-start">
                                                ...
                                                <div class="form-icon-container">
                                                    <input class="form-control form-icon-input @error('password') is-invalid @enderror" id="password" type="password" name="password" placeholder="Password" />
                                        ...
                                        <div class="text-center">
                                            <a class="fs--1 fw-bold" href="sign-up.html">Create an account</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
