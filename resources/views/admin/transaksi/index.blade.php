          ...
          <div class="d-flex flex-wrap gap-3">
            ...
            <div class="ms-xxl-auto">
              <a href="{{ route('batik.create') }}" class="btn btn-primary" id="addBtn">
                <span class="fas fa-plus me-2"></span>Tambah Transaksi
              </a>
            </div>
          </div>
        </div>
            ...
            <table class="table fs--1 mb-0">
              <thead>
                <tr>
                    ...
                    <th class="sort white-space-nowrap align-middle ps-4" scope="col" style="width:350px;">NAMA PELANGGAN</th>
                    <th class="sort align-middle text-end ps-4" scope="col" style="width:150px;">PRODUK DIBELI</th>
                    <th class="sort align-middle text-end ps-4" scope="col" style="width:150px;">JUMLAH PRODUK</th>
                    <th class="sort align-middle white-space-nowrap ps-4" scope="col" style="width:150px;">TOTAL HARGA</th>
                    <th class="sort align-middle ps-4" scope="col" style="width:200px;">TANGGAL TRANSAKSI</th>
