    ...
    <div class="collapse navbar-collapse justify-content-between">
      <div class="navbar-logo">
        ...
        <a class="navbar-brand me-1 me-sm-3" href="../../../index.html">
          <div class="d-flex align-items-center">
            <div class="d-flex align-items-center"><img src="{{ asset('images/logo_kinasih.png') }}" alt="phoenix" width="27" />
              <p class="logo-text ms-2 d-none d-sm-block">Rumah Kinasih</p>
            </div>
          </div>
        </a>
      </div>
      <ul class="navbar-nav navbar-nav-icons flex-row">
        ...
        <li class="nav-item dropdown"><a class="nav-link lh-1 pe-0" id="navbarDropdownUser" href="#!" role="button" data-bs-toggle="dropdown" data-bs-auto-close="outside" aria-haspopup="true" aria-expanded="false">
            <div class="avatar avatar-l ">
              <img class="rounded-circle " src="{{ asset('images/userlogo.jpg') }}" alt="" />
            </div>
          </a>
            ...
            <div class="card position-relative border-0">
              <div class="card-body p-0">
                <div class="text-center pt-4 pb-3">
                  ...
                  <h6 class="mt-n3 text-black">{{ Auth::user()->name }}</h6>
                </div>
