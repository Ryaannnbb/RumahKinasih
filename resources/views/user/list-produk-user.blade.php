                    ...
                    <div class="product-filter-offcanvas bg-soft scrollbar phoenix-offcanvas phoenix-offcanvas-fixed"
                        ...
                        <div class="d-flex justify-content-between align-items-center mb-3">
                            ...
                            <div class="d-flex align-items-center justify-content-between w-100">
                                <div class="fs-0 text-1000">Availability</div><span
                        ...
                        <div class="collapse show" id="collapseAvailability">
                            ...
                            <div class="d-flex align-items-center justify-content-between w-100">
                                <div class="fs-0 text-1000">Color family</div><span
                                    class="fa-solid fa-angle-down toggle-icon text-500"></span>
                            </div>
                        </a>
                        <div class="collapse show" id="collapseColorFamily">
                            ...
                            <div class="d-flex align-items-center justify-content-between w-100">
                                <div class="fs-0 text-1000">Brands</div><span
                                    class="fa-solid fa-angle-down toggle-icon text-500"></span>
                            </div>
                        </a>
                        <div class="collapse show" id="collapseBrands">
                            <div class="mb-2">
                                ...
                                <div class="form-check mb-0"><input class="form-check-input mt-0" id="flexCheckLG"
                                        type="checkbox" name="brands"><label
                                        class="form-check-label d-block lh-sm fs-0 text-900 mb-0 fw-normal"
                                        for="flexCheckLG">LG
                                    </label></div>
                            </div>
                        </div><a class="btn px-0 d-block collapse-indicator" data-bs-toggle="collapse"
                        ...
                        <div class="collapse show" id="collapseRating">
                            ...
                            <div class="d-flex align-items-center justify-content-between w-100">
                                <div class="fs-0 text-1000">Display type</div><span
                                    class="fa-solid fa-angle-down toggle-icon text-500"></span>
                            </div>
                        </a>
                        <div class="collapse show" id="collapseDisplayType">
                            ...
                            <div class="d-flex align-items-center justify-content-between w-100">
                                <div class="fs-0 text-1000">Condition</div><span
                                    class="fa-solid fa-angle-down toggle-icon text-500"></span>
                            </div>
                        </a>
                        <div class="collapse show" id="collapseCondition">
                            ...
                            <div class="d-flex align-items-center justify-content-between w-100">
                                <div class="fs-0 text-1000">Delivery</div><span
                                    class="fa-solid fa-angle-down toggle-icon text-500"></span>
                            </div>
                        </a>
                        <div class="collapse show" id="collapseDelivery">
                            ...
                            <div class="d-flex align-items-center justify-content-between w-100">
                                <div class="fs-0 text-1000">Campaign</div><span
                                    class="fa-solid fa-angle-down toggle-icon text-500"></span>
                            </div>
                        </a>
                        <div class="collapse show" id="collapseCampaign">
                            ...
                            <div class="d-flex align-items-center justify-content-between w-100">
                                <div class="fs-0 text-1000">Warranty</div><span
                                    class="fa-solid fa-angle-down toggle-icon text-500"></span>
                            </div>
                        </a>
                        <div class="collapse show" id="collapseWarranty">
                            ...
                            <div class="d-flex align-items-center justify-content-between w-100">
                                <div class="fs-0 text-1000">Warranty Type</div><span
                                    class="fa-solid fa-angle-down toggle-icon text-500"></span>
                            </div>
                        </a>
                        <div class="collapse show" id="collapseWarrantyType">
                            ...
                            <div class="d-flex align-items-center justify-content-between w-100">
                                <div class="fs-0 text-1000">Certification</div><span
                                    class="fa-solid fa-angle-down toggle-icon text-500"></span>
                            </div>
                        </a>
                                    ...
                                    <div class="d-flex flex-column justify-content-between h-100">
                                        <div>
                                            ...
                                            <p class="fs--1"><span class="fa fa-star text-warning"></span><span
                                                    ...
                                                    class="fa fa-star text-warning"></span><span
                                                    class="fa fa-star text-warning"></span><span
                                                    class="text-500 fw-semi-bold ms-1">(134 people rated)</span></p>
                                        </div>
                                        <div>
                                    ...
                                    <div class="d-flex flex-column justify-content-between h-100">
                                        <div>
                                            ...
                                            <p class="fs--1"><span class="fa fa-star text-warning"></span><span
                                                    ...
                                                    class="fa fa-star text-warning"></span><span
                                                    class="fa fa-star text-warning"></span><span
                                                    class="text-500 fw-semi-bold ms-1">(8 people rated)</span></p>
                                        </div>
                                        <div>
                                    ...
                                    <div class="d-flex flex-column justify-content-between h-100">
                                        <div>
                                            ...
                                            <p class="fs--1"><span class="fa fa-star text-warning"></span><span
                                                    ...
                                                    class="fa fa-star text-warning"></span><span
                                                    class="fa fa-star text-warning"></span><span
                                                    class="text-500 fw-semi-bold ms-1">(3 people rated)</span></p>
                                        </div>
                                        <div>
                                            <h3 class="text-1100">$299.00</h3>
                                            <p class="text-700 fw-semi-bold fs--1 lh-1 mb-0">3 colors</p>
                                    ...
                                    <div class="d-flex flex-column justify-content-between h-100">
                                        <div>
                                            ...
                                            <p class="fs--1"><span class="fa fa-star text-warning"></span><span
                                                    ...
                                                    class="fa fa-star text-warning"></span><span
                                                    class="fa fa-star text-warning"></span><span
                                                    class="text-500 fw-semi-bold ms-1">(1 people rated)</span></p>
                                        </div>
                                        <div>
                                        ...
                                        <div>
                                            <div class="border border-1 rounded-3 position-relative mb-3"><button
                                                    ...
                                                    title="Add to wishlist"><span
                                                        class="fas fa-heart d-block-hover"></span><span
                                                        class="far fa-heart d-none-hover"></span></button><img
                                                    class="img-fluid" src="../../../assets/img/products/20.png"
                                                    alt="" /></div><a class="stretched-link"
                                                href="product-details.html">
